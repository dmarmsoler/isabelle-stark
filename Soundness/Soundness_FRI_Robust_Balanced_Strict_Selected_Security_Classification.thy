theory Soundness_FRI_Robust_Balanced_Strict_Selected_Security_Classification
  imports
    Stark.Soundness_FRI_Robust_Security_Classification
    Stark.Soundness_FRI_Robust_Balanced_Strict_Selected_Trace_Classification
    Stark.Soundness_FRI_Robust_Balanced_Strict_Selected_Composition_Classification
...
lemma
  ro_absorb_checked_staged_security_clean_robust_classification_balanced_strict_selected_exact_two:
  ...
  shows
    "ro_absorb_checked_staged_security_query_head_dependent_actual_query_index_list_hit
     ...
     ro_absorb_checked_staged_security_query_head_dependent_actual_query_index_list_hit
       (fri_balanced_strict_selected_combined_query_head_lists C) out \<or>
            ...
            "hash_map_new_output_hit
             ...
             ro_query_head_dependent_actual_query_index_list_hit
                ...
                (Some ((((prefix, prefix_state), data, query_start, raws,
                  query_states), attacker_state)))"
          by (rule
            checked_builder_composition_not_robust_close_imp_strict_selected_residual_or_targets_balanced_exact_two[
          ...
          have lifted:
              "ro_absorb_checked_staged_security_clean_builder_merkle_target_hit
               ...
               ro_absorb_checked_staged_security_query_phase_builder_merkle_target_hit
                  out \<or>
               ro_absorb_checked_staged_security_query_head_dependent_actual_query_index_list_hit
                  (fri_balanced_strict_selected_combined_query_head_lists C) out"
          ...
          "hash_map_new_output_hit
           ...
           ro_query_head_dependent_actual_query_index_list_hit
              ...
              (Some ((((prefix, prefix_state), data, query_start, raws,
                query_states), attacker_state)))"
        by (rule
          checked_builder_trace_not_robust_close_imp_strict_selected_residual_or_targets_balanced_exact_two[
...
definition ro_absorb_checked_staged_balanced_strict_selected_obstruction_union
where
  "ro_absorb_checked_staged_balanced_strict_selected_obstruction_union C budgets out \<longleftrightarrow>
...
proof (rule wp_event_mono_on_support)
  ...
  assume support:
    ...
    and accepted_out: "accepted out"
  show
      "ro_absorb_checked_staged_balanced_strict_selected_obstruction_union C budgets out"
