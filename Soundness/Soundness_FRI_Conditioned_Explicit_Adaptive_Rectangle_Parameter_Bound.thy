theory Soundness_FRI_Conditioned_Explicit_Adaptive_Rectangle_Parameter_Bound
  imports
    Stark.Soundness_FRI_Conditioned_Explicit_Complete_List_Adaptive_Parameter_Bound
    Stark.Soundness_FRI_Conditioned_Explicit_Adaptive_Rectangle_Security
begin
...
definition
  ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_nonempty_parameter_error
...
lemma
  wp_ro_absorb_checked_staged_security_acceptance_conditioned_explicit_complete_list_adaptive_rectangle_nonempty_parameter_bound:
  ...
  shows
    "wp_event
      ...
      \<le> ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_nonempty_parameter_error
          budgets"
proof -
  let ?M =
    "ro_absorb_checked_staged_security_experiment_with_first_root_and_query_witnesses
  ...
  have query:
      "wp_event ?M ?Query adversary_initial_state \<le>
        ro_checked_staged_trace_composition_good_actual_query_rectangle_error_adaptive budgets"
    by (rule
      wp_ro_absorb_checked_staged_security_trace_composition_good_actual_query_rectangle_bound_adaptive[
        OF wf controlled])  have trace_target:
  ...
  have actual_residual:
      "wp_event ?M ?ActualResidual adversary_initial_state \<le>
        ro_checked_staged_conditioned_complete_list_actual_residual_rectangle_error_adaptive budgets"
    by (rule
  ...
  have padding:
      "wp_event ?M ?Padding adversary_initial_state \<le>
        ro_checked_staged_trace_composition_padding_rectangle_error_adaptive budgets"
    by (rule
      wp_ro_absorb_checked_staged_security_trace_composition_padding_rectangle_bound_adaptive[
        OF wf controlled])  have alpha:
  ...
  proof -
    ...
    show ?thesis
      using summed
      unfolding
        ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_nonempty_parameter_error_def
      by (simp add: add.assoc)
  qed
  show ?thesis
...
lemma ro_absorb_stark_soundness_conditioned_explicit_complete_list_adaptive_rectangle_nonempty:
  assumes false_statement: "\<not> exists_valid_trace"
    and wf: "staged_budget_wellformed budgets"
    and controlled: "staged_adversary_controlled budgets A"
    and nonempty: "0 < ceil_log clength"
...
where
  "ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_tightened_nonempty_parameter_error
      budgets =
    min
      (ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_tightened_nonempty_parameter_error
        budgets)
      (ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_nonempty_parameter_error
        budgets)"

lemma
  ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_tightened_nonempty_parameter_error_le_previous:
  "ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_tightened_nonempty_parameter_error
      budgets
    \<le> ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_tightened_nonempty_parameter_error
        budgets"
  unfolding
    ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_tightened_nonempty_parameter_error_def
  by simp
...
proof -
  have previous:
    ...
    ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_tightened_nonempty_parameter_error
      budgets"
    by (rule
        wp_ro_absorb_checked_staged_security_acceptance_conditioned_explicit_complete_list_adaptive_tightened_nonempty_parameter_bound[
          OF false_statement wf controlled nonempty])
  have rectangle:
    "wp_event
      (ro_absorb_checked_staged_security_experiment_with_first_root_and_query_witnesses
  ...
  show ?thesis
    unfolding
      ro_absorb_checked_staged_conditioned_explicit_complete_list_adaptive_rectangle_tightened_nonempty_parameter_error_def
    by (rule min.boundedI[OF previous rectangle])
qed

lemma
  ro_absorb_stark_soundness_conditioned_explicit_complete_list_adaptive_rectangle_tightened_nonempty:
  assumes false_statement: "\<not> exists_valid_trace"
    and wf: "staged_budget_wellformed budgets"
    and controlled: "staged_adversary_controlled budgets A"
    and nonempty: "0 < ceil_log clength"
