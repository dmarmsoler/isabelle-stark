theory Soundness_FRI_Robust_Exact_Rate_Security_Classification
  imports
...
lemma
  ro_absorb_checked_staged_security_clean_robust_classification_exact_two:
            ...
            "hash_map_new_output_hit
             ...
             ro_query_head_dependent_actual_query_index_list_hit
                ...
                (Some ((((prefix, prefix_state), data, query_start, raws,
                  query_states), attacker_state)))"
          by (rule
            checked_builder_composition_not_robust_close_imp_residual_or_targets_exact_two[
              OF wf controlled nonempty eval_power composition_exponent_fit
                K_pos composition_exact builder_out verifier_out final_clean
          ...
          "hash_map_new_output_hit
           ...
           ro_query_head_dependent_actual_query_index_list_hit
              ...
              (Some ((((prefix, prefix_state), data, query_start, raws,
                query_states), attacker_state)))"
        by (rule
          checked_builder_trace_not_robust_close_imp_residual_or_targets_exact_two[
            OF wf controlled nonempty eval_power trace_exponent_fit
              K_pos trace_exact builder_out verifier_out final_clean
