theory Soundness_FRI_Robust_Balanced_Strict_Selected_Trace_Classification
  imports
...
lemma checked_builder_trace_not_robust_close_imp_strict_selected_residual_or_targets_balanced_exact_two:
...
proof -
        ...
        by (rule
          fri_builder_authenticated_chain_robust_online_or_strict_selected_residual_balanced_exact_two[
            OF trace_chain eval_power round_count rounds_fit exact
              ...
              trace_authenticated query_idxs_space])
      have split:
          "(\<exists>j < length (map fst f_fl).
              map fst f_fl ! j \<in>
                fri_online_balanced_bad_challenges
      ...
      next
        ...
        have trace_head:
          ...
          using residual trace_roots_eq trace_challenges_eq trace_final_eq
