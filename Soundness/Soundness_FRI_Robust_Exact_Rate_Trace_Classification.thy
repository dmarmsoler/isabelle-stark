theory Soundness_FRI_Robust_Exact_Rate_Trace_Classification
  imports
...
lemma checked_builder_trace_not_robust_close_imp_residual_or_targets_exact_two:
...
proof -
      ...
      have exact:
          "fri_linear_exact_list_cap
            (clength - 1) (length (map fst f_fl)) K 2"
      ...
      have split_full:
        ...
        by (rule
          fri_builder_authenticated_chain_robust_online_or_residual_exact_two[
            OF trace_chain eval_power round_count exponent_fit K_pos exact
